...
{
    #[Route('/', name: 'app_IndexController')] // je cree une nouvelle route et une page ('/') qui affiche // # annotation equivalent de if comme dans index.php avant, permet de creer une nouvelle route cad une nouvelle page sur notre appli quand l url est appelée cela execute automatiquement la methode definit sous la route
    public function index () {  

        //var_dump('value:"hello World"');die; // je fais un var_dump pour recuperer un affichage "hello World"

        return $this->render('Page/indexView.html.twig'); // on peut directement render au lieu de sur deux lignes comme auparavant, cette methode est dans l AbstractController”
    } 
